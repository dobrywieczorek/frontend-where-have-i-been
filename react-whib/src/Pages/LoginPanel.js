		...
		token != null && token != 'null' ? <Navigate to="/" /> :
			<div className="mx-auto h-screen grid content-center">
				<div className="flex flex-col items-center pb-28">
					...
					<p className="mb-10">{t('logindesc')}</p>
					...
					<p className="mt-3">{t('donthaveaccountmsg')} <Link className="text-blue-400 hover:text-blue-700" to="/register">{t('register')}</Link></p>

					{loginUrl != null && (
						<a href={loginUrl} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 mt-2">{t('loginwithgoogle')}</a>
					)}
