		...
		token != null && token != 'null' ? <Navigate to="/" /> :
			<div className="mx-auto h-screen grid content-center">
				<div className="flex flex-col items-center pb-28">
					...
					<p className="mb-10">{t('logintoyouraccount')}</p>
					...
					<p className="mt-3">{t('donthaveanaccountmsg')} <Link className="text-blue-400 hover:text-blue-700" to="/register">{t('register')}</Link></p>
